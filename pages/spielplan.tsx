  ...
  return (
    <Layout>
      ...
      {eventMonthObjects.map((eventMonthObject, index) => (
        <div
          key={index}
          className={`mb-5 mx-sm-5 ${index % 2 === 0 ? 'text-right' : ''}`}
        >
          {index % 2 === 0 ? (
            <div>
              <div className="month-w-custom-hr">
                ...
                <h2 className="month-title-right">{eventMonthObject.name}</h2>

                <div className="month-content-right">
            ...
            <div>
              <div className="month-w-custom-hr">
                ...
                <h2 className="month-title-left">{eventMonthObject.name}</h2>

                <div className="month-content-left">
                  {eventMonthObject.events.map((event, index) => (
                    <div key={index}>
                      {event.dates.map((date, index) => (
                        <span key={index} className="h2">
